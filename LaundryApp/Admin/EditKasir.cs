    ...
    public partial class EditKasir : Form
    {
        ...
        private void LoadKasirData()
        {
            using (var conn = new DatabaseHelper().GetConnection())
            {
                ...
                cmd.Parameters.AddWithValue("@id", kasirId);
        ...
        private void EditKasir_Load(object sender, EventArgs e)
        {
        ...
        private void guna2Button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                using (var conn = new DatabaseHelper().GetConnection())
                {
                    ...
                    // kalau password diisi, hash dan update juga
                ...
                MessageBox.Show("Kasir berhasil diupdate!");
